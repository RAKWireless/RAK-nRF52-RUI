...
* This use case will demonstrate the use of the BLE customer API
  ...
  *
  * The application is made with RAK4631 and RAK1901
...
*/
uint8_t hts_tmep[CUS_BLE_TEMPERATURE_MEASUREMENT_CHAR_LEN] = {0x06, 0x00, 0x0A, 0x00, 0xFD, 0xE5, 0x07, 0x0A, 0x03, 0x0A, 0x0A, 0x01, 0x04};
