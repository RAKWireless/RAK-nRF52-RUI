# 1 "/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c"
...
# 1 "/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c"
# 40 "/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c"
...
# 41 "/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c" 2
...
void app_util_critical_region_enter(uint8_t *p_nested)
{
    ...
    if (0) { if (APP_LEVEL_PRIVILEGED == privilege_level_get()) { } else { assert_nrf_callback((uint16_t)67, (uint8_t *)"/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c"); } }
...
void app_util_critical_region_exit(uint8_t nested)
{
    ...
    if (0) { if (APP_LEVEL_PRIVILEGED == privilege_level_get()) { } else { assert_nrf_callback((uint16_t)81, (uint8_t *)"/home/eddieho/tmp/phase2_release/rui-v3/external/nRF5_SDK/nRF5_SDK_17.0.2_d674dde/components/libraries/util/app_util_platform.c"); } }
...
uint8_t current_int_priority_get(void)
{
    ...
    if (isr_vector_num > 0)
    {
        ...
        return (__NVIC_GetPriority((IRQn_Type)irq_type) & 0xFF);
    }
    else
    {
